 ...
 * @Edited by php-mods (Pilot Awards System v1.5)
 */
...
class PilotAdmin extends CodonModule
{
	...
	{
		$this->set('allawards', AwardData::adminpilawards($_REQUEST['pilotid']));
	...
	protected function ViewPilotDetails()
	{
		...
		$this->set('allawards', AwardData::adminpilawards($this->get->pilotid));
	...
	protected function AddAward()
	{
		...
		AwardsData::assign_points($this->post->pilotid);
